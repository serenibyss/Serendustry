...
class SerendustryMaterials {
    companion object {
        fun registerMaterials() {
            ...
            Water.setProperty(PropertyKey.PLASMA, PlasmaProperty())
            Flerovium.setProperty(PropertyKey.PLASMA, PlasmaProperty())
            Phosphorus.setProperty(PropertyKey.PLASMA, PlasmaProperty())
            Protactinium.setProperty(PropertyKey.PLASMA, PlasmaProperty())
            Redstone.setProperty(PropertyKey.PLASMA, PlasmaProperty())
            Glass.setProperty(PropertyKey.PLASMA, PlasmaProperty())
            Lead.setProperty(PropertyKey.PLASMA, PlasmaProperty())
            ...
            Signalium = Material.Builder(29, Serendustry.ID("signalium"))
                ...
                .fluidTemp(35000)
                .cableProperties(V.get(UIV), 2, 8192)
                .build()
            ...
            Quantium = Material.Builder(49, Serendustry.ID("quantium"))
                ...
                .cableProperties(V.get(OpV), 2, 131072)
                .fluidTemp(70000)
                .build()
                .setFormula("Qt")
            ...
            ScOpv = Material.Builder(53, Serendustry.ID("sc_opv"))
                ...
                .cableProperties(V.get(OpV), 24, 0, true)
                .fluidTemp(90000)
                .build()
            ...
            Floppa = Material.Builder(67, Serendustry.ID("floppa"))
                ...
                .fluidTemp(800000)
                .cableProperties(V.get(MAX), 24, 0, true)
                .build()
