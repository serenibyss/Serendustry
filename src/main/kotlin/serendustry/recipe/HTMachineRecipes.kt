...
internal fun htMachineRecipes() {/* todo

    // Machine Casings

    ModHandler.addShapedRecipe(true, "casing_uev", MACHINE_CASING.getItemVariant(UEV), "PPP", "PwP", "PPP", 'P', UnificationEntry(plate, HastelloyK243))
    ModHandler.addShapedRecipe(true, "casing_uiv", MACHINE_CASING.getItemVariant(UIV), "PPP", "PwP", "PPP", 'P', UnificationEntry(plate, Enderiiium))
    ModHandler.addShapedRecipe(true, "casing_uxv", MACHINE_CASING.getItemVariant(UXV), "PPP", "PwP", "PPP", 'P', UnificationEntry(plate, AwakenedDraconium))
    ModHandler.addShapedRecipe(true, "casing_opv", MACHINE_CASING.getItemVariant(OpV), "PPP", "PwP", "PPP", 'P', UnificationEntry(plate, Quantum))
    ModHandler.addShapedRecipe(true, "casing_max", MACHINE_CASING.getItemVariant(MAX), "PPP", "PwP", "PPP", 'P', UnificationEntry(plateDense, Floppa))
    ...
    //GTRecipeHandler.removeRecipesByInputs(ASSEMBLER_RECIPES, MACHINE_CASING.getItemVariant(UHV), UnificationEntry(cableGtSingle, Europium), Polybenzimidazole.getFluid(288))
    ...
    ModHandler.addShapedRecipe(true, "casing_uev", MACHINE_CASING.getItemVariant(UXV), "CDC", "DHD", "PDP",
            'C', UnificationEntry(cableGtQuadruple, Bedrockium)
            'P', UnificationEntry(plate, AwakenedDraconium))
