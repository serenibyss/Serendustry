...
public class DestabilizedMatterChain {
    public static void init() {
        ...
        LABORATORY_RECIPES.recipeBuilder()
                ...
                .requireInside(RecipeMaps.CHEMICAL_RECIPES, GTValues.UEV, 1).requireInside(ELECTROLYZER_RECIPES, GTValues.UEV, 1)
        ...
        LABORATORY_RECIPES.recipeBuilder()
                ...
                .requireInside(LASER_ENGRAVER_RECIPES, GTValues.UV, 1)
