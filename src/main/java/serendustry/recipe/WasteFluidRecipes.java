...
import static serendustry.item.SerendustryMetaItems.wasteFluidExtractor;
import static serendustry.item.SerendustryMetaItems.wasteFluidExtractorFilled;
...
public class WasteFluidRecipes {
    ...
    public static void init() {
        ...
        EXTRACTOR_RECIPES.recipeBuilder()
                ...
                .fluidOutputs(SerendustryMaterials.animalWaste.getFluid(1000))
