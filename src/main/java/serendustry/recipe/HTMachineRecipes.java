...
public class HTMachineRecipes {
    ...
    public static void init() {
         ...
         * UnificationEntry(cableGtSingle, Europium), Polybenzimidazole.getFluid(288))
         * 
         * ASSEMBLER_RECIPES.recipeBuilder()
